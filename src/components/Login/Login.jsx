    ...
    <div className="flex items-center justify-center h-screen bg-gray-100">
      <div className="bg-white p-8 rounded-lg shadow-lg w-full max-w-md">
        <h2 className="text-2xl font-bold mb-6 text-center">Login</h2>
          ...
          <div className='text-right mt-2 hover:underline text-blue-600 cursor-pointer '>
           Forgot password
          </div>
        ...
        <div className='text-center  my-2 '>Don't have an account? <Link to="/signup"><span className='text-orange-500 hover:underline  cursor-pointer'>Sign up</span></Link></div>
